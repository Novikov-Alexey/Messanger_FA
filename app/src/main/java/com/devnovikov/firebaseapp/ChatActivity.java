...
import com.devnovikov.firebaseapp.adapters.AdapterChat;
import com.devnovikov.firebaseapp.models.ModelChat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    //uid
    public static final String EXTRA_UID = "hisUid";
    String hisUid;
    String myUid;
    String hisImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * So get that uid here to get the profile picture, name and start chat with that user*/
        ...
        hisUid = intent.getStringExtra(EXTRA_UID);
    ...
    private void sendMessage(String message) {
        // StringBuilder translateMessage = new StringBuilder(translate(message));
