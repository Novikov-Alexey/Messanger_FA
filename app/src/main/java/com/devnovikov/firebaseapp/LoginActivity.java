...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle google button login click
    ...
    private void showRecoverPasswordDialog() {
        ...
        /*sets the min width of a EditView to fit a text of n 'M' letters regrdless of the actual text extension and text size*/
        ...
        builder.setPositiveButton("Recover", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    ...
                    beginRecovery(email); // start recovery correct email
                }
            }
        });
        //button cancel
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()){
                            Toast.makeText(LoginActivity.this, "Email sent on your address", Toast.LENGTH_SHORT).show();
                        } else {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getResult().getAdditionalUserInfo().isNewUser()){
                                ...
                                //When user is registered store user in firebase realtime database too using HashMap
                                ...
                                hashMap.put("language", language); //will UPDATE later
